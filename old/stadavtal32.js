...
// Test for JavaScript linkage
document.addEventListener('DOMContentLoaded', () => {
    const jsTestElement = document.getElementById('js-test');
    const jsNotLinkedElement = document.getElementById('js-not-linked');
    
    if (jsTestElement) {
        jsTestElement.style.display = 'block';
        console.log('JavaScript är korrekt kopplat!');
    }
    
    if (jsNotLinkedElement) {
        jsNotLinkedElement.style.display = 'none';
    }
});
