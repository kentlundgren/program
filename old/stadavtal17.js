...
function exportToExcel() {
    ...
    // NYTT: Skapa ett objekt för kolumnrubriker
    const headers = columnOrder.reduce((obj, col) => ({...obj, [col]: col}), {});

    // NYTT: Formatera data med garanterade kolumner
    ...
    // NYTT: Skapa worksheet med headers först
...
// Formulärhantering med förbättrad validering
